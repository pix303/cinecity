...
For examples of actor model implementation in Go you should see [https://github.com/vladopajic/go-actor](go-actor) or [hollywood](https://github.com/anthdm/hollywood)
